import{_ as s,c as a,o as i,a4 as n}from"./chunks/framework.BmdFiWrL.js";const o=JSON.parse('{"title":"Dashboard 反向代理配置","description":"","frontmatter":{},"headers":[],"relativePath":"guide/q3.md","filePath":"guide/q3.md","lastUpdated":1742391121000}'),p={name:"guide/q3.md"},l=n(`<h1 id="dashboard-反向代理配置" tabindex="-1">Dashboard 反向代理配置 <a class="header-anchor" href="#dashboard-反向代理配置" aria-label="Permalink to &quot;Dashboard 反向代理配置&quot;">​</a></h1><p>从 V1 版本开始，不再区分 Dashboard 和 gRPC 端口，访问与通信均通过默认的 <code>8008</code> 端口。</p><hr><h2 id="nginx-配置示例" tabindex="-1">Nginx 配置示例 <a class="header-anchor" href="#nginx-配置示例" aria-label="Permalink to &quot;Nginx 配置示例&quot;">​</a></h2><p>以下是使用 Nginx 配置反向代理的示例：</p><div class="language-nginx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">nginx</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">server</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">        # proxy_set_header X-Forwarded-Proto $scheme; # 如果你使用nginx作为最外层，就启用此行避免无法正确读取访问的协议</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">        proxy_pass </span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">http://127.0.0.1:8008;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span>
<span class="line"></span>
...
<span class="line"><span>        to localhost:8008</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><hr><h3 id="配置注意事项" tabindex="-1">配置注意事项 <a class="header-anchor" href="#配置注意事项" aria-label="Permalink to &quot;配置注意事项&quot;">​</a></h3><ol><li><p><strong>调整 Header</strong><br> 根据您使用的 CDN 服务商，替换 <code>CF-Connecting-IP</code> 和相关配置为您的 CDN 提供的私有 header。</p></li><li><p><strong>HTTPS 配置</strong><br> 确保 SSL 证书路径正确，并已正确配置域名解析。</p></li><li><p><strong>负载调整</strong><br> 根据服务器性能和访问需求，可调整 <code>keepalive</code> 和 <code>buffer</code> 设置。</p></li></ol><hr>`,14),h=[l];function e(t,k,r,d,E,g){return i(),a("div",null,h)}const y=s(p,[["render",e]]);export{o as __pageData,y as default};
